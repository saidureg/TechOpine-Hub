...
async function run() {
  try {
    ...
    const userCollection = client.db("techOpineDB").collection("users");
    const productCollection = client.db("techOpineDB").collection("products");
    const upVoteCollection = client.db("techOpineDB").collection("upVote");
    const downVoteCollection = client.db("techOpineDB").collection("downVote");
    const featureCollection = client.db("techOpineDB").collection("features");
    const reviewsCollection = client.db("techOpineDB").collection("reviews");
    const reportCollection = client.db("techOpineDB").collection("reports");
    const couponCollection = client.db("techOpineDB").collection("coupon");
    const paymentCollection = client.db("techOpineDB").collection("payments");
